      ...
      <View style={styles.cardBody}>
        ...
        <View style={styles.cardMeta}>
          <View style={styles.venueRow}>
            ...
            <Text style={styles.venueText}>{coupon.venue}</Text>
          </View>
          {coupon.expiresAt && (
            <View style={styles.expiryRow}>
              <Ionicons name="time-outline" size={11} color={COLORS.textMuted} />
              <Text style={styles.expiryText}>Até {coupon.expiresAt}</Text>
            </View>
          )}
        </View>
      ...
      {nearbyCoupons.length > 0 && (
        <View style={styles.alertBanner}>
          ...
          <Text style={styles.alertText}>
            <Text style={{ fontWeight: '700' }}>{nearbyCoupons.length} cupons</Text> disponíveis nos eventos próximos! Não perca.
          </Text>
        </View>
      )}
