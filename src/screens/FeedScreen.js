      ...
      >
        {composing && (
          <View style={styles.composer}>
            ...
            <Text style={styles.composerLabel}>Tipo de post</Text>
            ...
            <View style={styles.composerActions}>
              ...
              <TouchableOpacity
                style={[styles.postBtn, (!newText.trim() || !selectedEvent) && styles.postBtnDisabled]}
                onPress={submitPost}
                disabled={!newText.trim() || !selectedEvent}
              >
