...
// Credenciais carregadas de variáveis de ambiente (Expo SDK 49+).
// Configure o arquivo .env na raiz do projeto (veja .env.example).
// Fallback para os valores hardcoded caso as env vars não estejam disponíveis
// (ex: build legado ou ambiente sem .env configurado).
